...
export default function RegisterPage() {
  ...
  const fields = [
    ...
    { key: 'displayName', label: 'Görünen Ad', type: 'text', auto: 'name' },
    { key: 'username', label: 'Kullanıcı Adı', type: 'text', auto: 'username' },
    { key: 'password', label: 'Şifre', type: 'password', auto: 'new-password' },
  ]
  ...
  return (
    ...
    >
      <div className="text-center mb-6">
        ...
        <h1 className="text-2xl font-bold mb-1" style={{ color: '#f0e4e7' }}>Hesap Oluştur</h1>
        <p className="text-sm italic" style={{ color: '#7a5a62' }}>Ahenk'e katıl</p>
      </div>
      ...
      <p className="mt-5 text-sm text-center" style={{ color: '#7a5a62' }}>
        Zaten hesabın var mı?{' '}
        <Link href="/login" className="font-semibold hover:underline" style={{ color: '#c96b82' }}>
          Giriş Yap
        </Link>
      </p>
    </div>
